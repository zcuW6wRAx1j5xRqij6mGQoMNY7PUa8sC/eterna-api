...
class SymbolSpotResource extends JsonResource
{
    /**
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'is_collection'=>UserCollectionSymbol::where('symbol_id', $this->id)->where('symbol_type', SymbolEnums::SymbolTypeSpot)->where('uid', $request->user()->id)->exists(),
        ];
    }
}
